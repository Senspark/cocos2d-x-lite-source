...
- (id)initWithDictionary:(NSDictionary*)dict{
    ...
    if (self) {
        ...
        self.marketPriceMicros = [[dict objectForKey:JSON_MARKETITEM_MARKETPRICEMICROS] doubleValue];
    }
...
- (NSDictionary*)toDictionary{
    return @{
             ...
             JSON_MARKETITEM_MARKETPRICEMICROS: [NSNumber numberWithDouble:marketPriceMicros]
             };
}

- (void)setMarketInformation:(NSString *)priceAndCurrency andTitle:(NSString *)title andDescription:(NSString *)description
             andCurrencyCode:(NSString *)currencyCode andPriceMicros:(double)priceMicros {
