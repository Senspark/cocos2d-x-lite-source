...
//                        __Integer *marketPriceMicros = dynamic_cast<__Integer *>(marketItem->objectForKey("marketPriceMicros"));
                        auto marketPriceMicros = marketItem->objectForKey("marketPriceMicros");
...
//                        mi->setMarketPriceMicros(marketPriceMicros);
                        ...
                        if (dynamic_cast<cocos2d::__Double*>(marketPriceMicros) != nullptr) {
                            mi->setMarketPriceMicros(static_cast<cocos2d::__Double*>(marketPriceMicros));
                        } else {
                            auto t = dynamic_cast<cocos2d::__Integer*>(marketPriceMicros);
                            mi->setMarketPriceMicros(cocos2d::__Double::create(static_cast<double>(t->getValue())));
                        }
